...
const EditItems = () => {
    ...
    const fetchItemData = async () => {
        try {
            ...
            // Update to match the new data structure
            setFormData({
                ...
                price_12_jam: response.data.price_12_jam,
                price_1_hari: response.data.price_1_hari,
                price_2_hari: response.data.price_2_hari
            });
            if (response.data.gambar) {
                setImagePreview(response.data.gambar);
            }
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const dataToSubmit = {
                ...formData,
                _method: 'PUT' // Laravel form method spoofing for POST request
            };
            ...
            const response = await AxiosInstance.post(`/api/barang/${id}`, formDataToSend, {
            ...
            if (error.response) {
                ...
                alert(error.response.data.message || "Gagal mengupdate barang");
            }
        } finally {
            setLoading(false);
        }
